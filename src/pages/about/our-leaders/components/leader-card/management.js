...
export const management = [
  {
    ...
    link: "#",
    description: [
      "Mohamad Zaharuddin holds a Diploma in Business Management from Universiti Teknologi MARA (UiTM), graduating in 1989. He began his professional journey in 1990 as an Industrial Trainee at Texas Instruments (Malaysia). During his brief tenure, he demonstrated exceptional skills and consistently met production targets, leaving a lasting impression on his employer.",
      "In 1992, he joined Advent Malaysia Sdn Bhd as a Sales Manager, where he steadily achieved impressive monthly sales targets. Recognized for his performance and leadership, he was promoted to Group Sales and Marketing Director in early 1994. Later that year, Mohamad Zaharuddin accepted an opportunity with D’or Rue Sdn Bhd as Technical and Operations Director. In this role, he oversaw daily operations and played a pivotal role in improving production efficiency. His efforts significantly boosted the company's annual sales revenue, surpassing the RM10 million mark.",
      "With over 30 years of expertise in production and sales management, Mohamad Zaharuddin joined Hyrax Oil Sdn Bhd in 2019 as International Sales Manager. He excelled in expanding the company’s presence into new international markets. In recognition of his consistent achievements and leadership, he was promoted to General Manager of International Sales in 2021, continuing to drive Hyrax Oil's global growth.",
    ],
  },
  {
    src: image2,
