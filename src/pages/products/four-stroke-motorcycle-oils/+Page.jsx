...
import { productsFSMO } from "../../../data/products/productsFSMO";
...
function Page() {
  ...
  const segment = productSegments.find(
    (item) => item.link === "/products/four-stroke-motorcycle-oils" // TODO: Adjust the link as necessary
  );
