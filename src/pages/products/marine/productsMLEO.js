export const productsMLEO = [
  {
    ...
    grades: ["15W-40"],
    pdsLink: "./products/marine/Hyrax-Admiral.pdf",
  },
  {
    src: "./products/Hyrax-Drum.webp",
    alt: "Hyrax TOP DEO",
    ...
    pdsLink: "./products/marine/Hyrax-TOP-DEO.pdf",
  },
  {
    src: "./products/Hyrax-Drum.webp",
    ...
    pdsLink: "./products/marine/Hyrax-Samudra-RF-Series.pdf",
  },
  {
    src: "./products/Hyrax-Drum.webp",
    ...
    pdsLink: "./products/marine/Hyrax-Samudra-DF-Series.pdf",
  },
  {
    src: "./products/Hyrax-Drum.webp",
    ...
    grades: ["SAE 50"],
    pdsLink: "./products/marine/Hyrax-Samudra-CL-570.pdf",
  },
  {
    src: "./products/Hyrax-Drum.webp",
    ...
    grades: ["SAE 50"],
    pdsLink: "./products/marine/Hyrax-Samudra-CL-540.pdf",
  },
  {
    src: "./products/Hyrax-Drum.webp",
    ...
    grades: ["SAE 30"],
    pdsLink: "./products/marine/Hyrax-Samudra-SO-306.pdf",
  },
  {
    src: "./products/Hyrax-Drum.webp",
    ...
    pdsLink: "./products/marine/Hyrax-Locomotive-Oil.pdf",
  },
];
