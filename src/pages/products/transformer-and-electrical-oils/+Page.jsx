...
import { productsTEO } from "../../../data/products/productsTEO";
...
function Page() {
  ...
  const segment = productSegments.find(
    (item) => item.link === "/products/transformer-and-electrical-oils" // TODO: Adjust the link as necessary
  );
